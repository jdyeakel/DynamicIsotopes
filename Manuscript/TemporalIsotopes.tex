...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{fig_AvgDiff.pdf}
\caption{
}
  \label{figavgdiff}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{fig_Offset.pdf}
\caption{
}
  \label{figoffset}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{fig_EVarTemp.pdf}
\caption{
}
  \label{figevart}
\end{figure}
